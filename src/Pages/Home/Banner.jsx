    ...
    <div>
      ...
      >
        ...
        <div
          ...
          className="parallax-bg w-full h-[650px] bg-no-repeat bg-cover absolute bg-[url('https://cms.nvctrading.com/app/uploads/2017/12/online-shopping.jpg')]"
            ...
            <div className="hero flex flex-col items-center justify-center min-h-[650px]">
              <div className="hero-content text-center">
                <div className="max-w-lg gro">
                  <h1 className="text-4xl font-bold gro">Welcome to Product Mart</h1>
                  <p className="py-6">
